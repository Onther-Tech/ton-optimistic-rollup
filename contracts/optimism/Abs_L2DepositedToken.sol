...
/* Interface Imports */
import { iOVM_L2DepositedToken } from "./iOVM_L2DepositedToken.sol";
 ...
 * Runtime target: OVM
 */
contract Abs_L2DepositedToken is iOVM_L2DepositedToken, OVM_CrossDomainEnabled {
        ...
        internal
    {
        ...
        bytes memory data = abi.encodeWithSelector(
            ...
            bytes4(keccak256(bytes("finalizeWithdrawal(address,uint256)"))),
            _to,
            _amount
        );
